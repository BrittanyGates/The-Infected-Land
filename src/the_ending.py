...
def the_ending(hero, villain) -> None:
    ...
    console.print()
    sleep_print()
    console.print(f"{villain.name} collapses onto the ground and blood gushes out of his body.", justify="center")
    console.print()
    sleep_print()
    console.print(f"{hero.name} stands over the {villain.name}.", justify="center")
    console.print()
    sleep_print()
    console.print(f"{villain.name}: \"Go ahead and kill me.\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{hero.name}: \"Who are you?\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{villain.name}: \"I forgot my name. It's been so long since anyone used it.\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{villain.name}: \"I was sent by The Great Power long ago.\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{villain.name}: \"I was good. I was pure.\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{hero.name}: \"What happened? Why did you become evil?\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{villain.name}: \"Corruption.\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{hero.name}: \"I don't understand.\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{villain.name}: \"I don't either. I started having bad thoughts.\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{villain.name}: \"I thought about killing the people.\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{villain.name}: \"I thought about destroying the land.\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{villain.name}: \"Eventually, I succumbed to my thoughts.\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{villain.name}: \"It will happen to you if you stay here.\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{hero.name}: \"I won't. I'm strong.\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{villain.name}: \"So was I. Leave here. Go back to The Great Power.\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{hero.name}: \"These residents need me!\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{villain.name}: \"They will survive without you. They did without me.\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{hero.name}: \"I'm not like you.\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{villain.name}: \"You will become like me. Learn from my mistake.\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{hero.name}: \"You're trying to manipulate me. It won't work.\"", justify="center")
    console.print()
    sleep_print()
    console.print(f"{villain.name} sighs and closes his eyes.", justify="center")
    console.print()
    sleep_print()
